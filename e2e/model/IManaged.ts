...
export interface IWrappedLayout<Data = any, Payload = any> {
     ...
     */
    isReadonly?: PickProp<IField, 'isReadonly'>;
    /**
     ...
     */
    features?: PickProp<IField, 'features'>;
    /**
     * Represents the `disabled` property of a field.
     *
     * @typedef Disabled
     */
    disabled?: PickProp<IField, 'disabled'>;
    /**
     ...
     */
    phoneHidden?: PickProp<IField, 'phoneHidden'>;
    /**
     * Represents the optional property 'tabletHidden' in a field object.
     *
     * @typedef tabletHidden
     */
    tabletHidden?: PickProp<IField, 'tabletHidden'>;
    /**
     * Represents the optional property `desktopHidden` of type `PickProp<IField, 'desktopHidden'>`.
     *
     * @typedef desktopHidden
     */
    desktopHidden?: PickProp<IField, 'desktopHidden'>;
    /**
     ...
     */
    noBaseline?: PickProp<IField, 'noBaseline'>;
}

/**
 * Типизацию компоновки следует вынести отдельно
 */
export interface IManagedLayout<Data = any, Payload = any> extends IWrappedLayout<Data, Payload> {
    /**
     ...
     *
     * @typedef IFieldKey
     * @typedef PickProp<IField, 'sx'> SxProp
     *
     ...
     * @property desktopColumns - Optional property to pick the 'desktopColumns' property from 'IField' interface.
     */
 ...
 * поля
 */
export interface IManagedShallow<Data = any, Payload = any> extends IManagedLayout<Data> {
    /**
     ...
     * @typedef Payload
     *
     * @type {PickProp<IField, 'isDisabled'>}
     *
     * @description
     ...
     */
    isIncorrect?: PickProp<IField, 'isIncorrect'>;
     ...
     */
    shouldRecompute?: PickProp<IField, 'shouldRecompute'>;
    /**
     ...
     */
    shouldUpdateItemList?: PickProp<IField, 'shouldUpdateItemList'>;
    /**
     ...
     */
    shouldUpdateTr?: PickProp<IField, 'shouldUpdateTr'>;
    /**
     ...
     * @template K - The property key to pick from `IField`.
     *
     * @typedef compute
     *
     ...
     *
     * The 'blur' property is an optional property of type PickProp<IField, 'blur'>.
     ...
     * @typedef menuItems
     */
    menuItems?: PickProp<IField, 'menuItems'>;
    /**
     ...
     */
    defaultValue?: PickProp<IField, 'defaultValue'>;
    /**
 ...
 */
export interface IManaged<Data = any, Value = any> extends Omit<IEntity<Data>, keyof Exclude<Data>> {
    name: string;
    value: Value;
    dirty: boolean;
